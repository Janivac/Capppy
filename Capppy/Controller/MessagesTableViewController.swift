...
// ## tady se nezobrazuje fotka trvale! vyřeš
...
class MessagesTableViewController: UITableViewController {
    ...
    func setupNavigationBar() {
        ...
        let radarItem = UIBarButtonItem(image: UIImage(named: "icon-radar"), style: .plain, target: self, action: #selector(radarItemDidTap))
           radarItem.tintColor = .darkGray
