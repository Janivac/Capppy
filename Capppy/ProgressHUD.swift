...
public class ProgressHUD: UIView {
    ...
    //    private var imageSuccess    = UIImage.checkmark.withTintColor(UIColor.systemPink, renderingMode: .alwaysOriginal)
        private var imageSuccess = UIImage.checkmark.withTintColor(UIColor(red: 255/255, green: 142/255, blue: 172/255, alpha: 1), renderingMode: .alwaysOriginal)
    
//    private var imageError        = UIImage.remove.withTintColor(UIColor.systemRed, renderingMode: .alwaysOriginal)
    
    private var imageError        = UIImage.remove.withTintColor(UIColor(red: 255/255, green: 142/255, blue: 172/255, alpha: 1), renderingMode: .alwaysOriginal)
